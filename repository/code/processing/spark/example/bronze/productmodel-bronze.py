...
if __name__ == '__main__':
    ...
    spark = SparkSession \
        .builder \
        .appName("productmodel-bronze-py") \
    ...
    # variables
    topic = "src-example-productmodel"
    destination_folder = "/example/productmodel/"
    ...
    if DeltaTable.isDeltaTable(spark, bronze):
        ...
        dt_table.alias("historical_data")\
            .merge(
                ...
                '''
                historical_data.ProductModelID = new_data.ProductModelID 
