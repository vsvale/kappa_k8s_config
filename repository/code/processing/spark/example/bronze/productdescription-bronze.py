...
if __name__ == '__main__':
    ...
    spark = SparkSession \
        .builder \
        .appName("productdescription-bronze-py") \
    ...
    # variables
    topic = "src-example-productdescription"
    destination_folder = "/example/productdescription/"
    ...
    if DeltaTable.isDeltaTable(spark, bronze):
        ...
        dt_table.alias("historical_data")\
            .merge(
                ...
                '''
                historical_data.ProductDescriptionID = new_data.ProductDescriptionID 
