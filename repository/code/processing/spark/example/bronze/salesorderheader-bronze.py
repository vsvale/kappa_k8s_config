...
if __name__ == '__main__':
    ...
    spark = SparkSession \
        .builder \
        .appName("salesorderheader-bronze-py") \
    ...
    # variables
    topic = "src-example-salesorderheader"
    destination_folder = "/example/salesorderheader/"
    ...
    if DeltaTable.isDeltaTable(spark, bronze):
        ...
        dt_table.alias("historical_data")\
            .merge(
                ...
                '''
                historical_data.SalesOrderID = new_data.SalesOrderID 
